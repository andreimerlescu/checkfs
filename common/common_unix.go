...
// GetCreationTime retrieves the creation time of a file or directory on Unix-like systems
...
// GetOwnerAndGroup retrieves the owner UID and group GID of a file or directory on Unix-like systems
